...
import { getBestFinishLabel, getTeamDisplayName } from '../utils/data';
...
function TeamPage() {
  ...
  const { team, squad, squadPlayers, wcHistory, loading, error } = useTeamPageData(flagCode);
  ...
  return (
    <section className="page team-page">
      ...
      {squad && (
        <div className="team-page-coach">
          <span className="team-page-coach-label">Coach</span>
          <span className="team-page-coach-name">{squad.coach.name}</span>
          {squad.coach.nationality && (
            <span className="team-page-coach-nationality">({squad.coach.nationality})</span>
          )}
          {captain && (
            <>
              <span aria-hidden="true"> · </span>
              <span className="team-page-captain">Captain: {captain.name}</span>
            </>
          )}
        </div>
      )}
